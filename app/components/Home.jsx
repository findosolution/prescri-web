    ...
    return(
      <div>
        <div className="top-bar">
          <div className="row">
            <div className="columns large-2 medium-2">
              LOGO
            </div>
            <div className="columns large-5 medium-2">
            </div>
            <div className="columns large-5 medium-2">
              <div className="row text-small login-box">
              ...
              <div className="row">
                ...
                <div className="columns large-5  large-offset-5 medium-2">
                  <div className="row">
        ...
        <div className="row add-prescription">
          <div className="columns large-2  large-offset-10 medium-2">
            <button type="button">
              <img src="images/green-plus-sign-th.png"/>
            </button>
          </div>
        </div>
        ...
        <div className="row">
          <button type="button">
            <img src="images/1.svg" width="1500px"/>
          </button>
        </div>
